! function(e) {
    ...
    e("[data-bg-src]").length > 0 && e("[data-bg-src]").each((function() {
        ...
        return this.each((function() {
            ...
            function l(e) {
                ...
                i.css("--height-set", e.outerHeight() + "px"), i.css("--width-set", e.outerWidth() + "px"), i.css("--pos-y", t.top + a + "px"), i.css("--pos-x", t.left + n + "px")
            }
        }))
    ...
    function h() {
        ...
        (function() {
            ...
            function n(n) {
                n = n.split(",");
                for (var i = 0; i < n.length; i++) t = l + " " + n[i], e(t).val() ? (e(t).removeClass("is-invalid"), a = !0) : (e(t).addClass("is-invalid"), a = !1)
            }
    ...
    function m() {
        window.innerWidth > 991 ? (p || (p = new Lenis({
            lerp: .1
        }), p.on("scroll", ScrollTrigger.update), gsap.ticker.add(e => {
            p && p.raf(1e3 * e)
    ...
    if (e(l).on("submit", (function(e) {
        ...
        })), m(), window.addEventListener("resize", m), window.addEventListener("resize", m), e(document).on("DOMContentLoaded", (function() {
            if (e(".sticky-wrapper").length > 0) {
                function t() {
                    e(".sticky-wrapper").hasClass("sticky") ? e("#smooth-wrapper").css("padding-top", "0") : (e(".th-header").outerHeight(), e("#smooth-wrapper").css("padding-top", "0px"))
                }
                if (t(), e(window).on("resize", t), "undefined" != typeof MutationObserver) new MutationObserver((function(e) {
                    e.forEach((function(e) {
                        "attributes" === e.type && "class" === e.attributeName && t()
                    }))
    ...
    if (gsap.utils.toArray(".th-parallax").forEach(e => {
        ...
        TweenMax.to({}, .016, {
            repeat: -1,
            onRepeat: function() {
                f += (b - f) / 9, v += (y - v) / 9, TweenMax.set(g, {
                    css: {
                        left: f - 12,
                        top: v - 12
                    }
    ...
    e.fn.lettering = function(t) {
        ...
        e(this).each((function() {
            var n, i, s, o, r, c = e(this);
            n = Math.floor(c.height() / 2), i = c.attr(t), s = c.attr(a), o = S(e(s).css("padding-top")), r = S(e(s).css("padding-bottom")), "top-half" === i ? (e(s).css("padding-bottom", r + n + "px"), c.css("margin-top", "-" + n + "px")) : "bottom-half" === i && (e(s).css("padding-top", o + n + "px"), c.css("margin-bottom", "-" + n + "px"))
        }))
    };
    ...
    function L() {
        e(".feature-circle .progressbar").each((function() {
            ...
            a < n + e(window).height() - 30 && !s && (e(this).data("animate", !0), e(this).find(".circle").circleProgress({
    ...
    }, e(".shape-mockup") && e(".shape-mockup").shapeMockup(), e((function() {
    ...
    }), e(".from").text("$" + e(".price_slider").slider("values", 0)), e(".to").text("$" + e(".price_slider").slider("values", 1)), L(), e(window).scroll(L);
    var E = e(window);
    ...
    E.on("scroll", D), E.on("load", D), e("#ship-to-different-address-checkbox").on("change", (function() {
    ...
    e(".pricing-tabs").length && (A.addEventListener("click", (function() {
        q.checked = !1, A.classList.add("toggler--is-active"), I.classList.remove("toggler--is-active"), B.classList.remove("hide"), j.classList.add("hide")
    })), I.addEventListener("click", (function() {
        q.checked = !0, I.classList.add("toggler--is-active"), A.classList.remove("toggler--is-active"), B.classList.add("hide"), j.classList.remove("hide")
    })), q.addEventListener("click", (function() {
        I.classList.toggle("toggler--is-active"), A.classList.toggle("toggler--is-active"), B.classList.toggle("hide"), j.classList.toggle("hide")
    })));
    new WOW({
        boxClass: "wow",
    ...
    (new WOW).init(), e(".th-progress").each((function() {
        ...
        e(".project-area2").attr("data-background", a).css("background-image", a ? `url(${a})` : "")
